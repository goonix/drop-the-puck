...
export default function BracketOverlay({ series, onClose }: Props) {
  useEffect(() => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
      ...
      {/* Panel */}
      <div className="relative bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full overflow-hidden"
        style={{ maxWidth: 1400 }}
      >
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700/50 shrink-0">
          <h2 className="text-base font-bold text-gray-900 dark:text-white">Stanley Cup Playoffs</h2>
          <button
            onClick={onClose}
