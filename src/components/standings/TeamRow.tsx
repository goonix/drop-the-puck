...
export function TeamRow({ standing, rank }: Props) {
    ...
    >
      ...
      <td className="py-2 pr-3">
        <div className="flex items-center gap-2">
          ...
          <span
            className={`text-sm font-medium ${fav ? 'text-gray-900 dark:text-white' : 'text-gray-700 dark:text-gray-200'}`}
          >
            {standing.teamAbbrev}
      ...
      <td className="py-2 px-2 text-center text-sm text-gray-600 dark:text-gray-300 tabular-nums">
      ...
      <td className="py-2 pl-2 pr-3 text-center text-sm font-bold text-gray-900 dark:text-white tabular-nums">
        {standing.points}
      </td>
